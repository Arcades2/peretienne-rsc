  ...
  return (
    <div className="container mx-auto prose dark:prose-invert md:prose-lg print:prose">
      ...
      <p>
        ...
        ), I have made a significant contribution to projects in the field of
        biotechnology. I played a key role in the maintenance and enhancement of{" "}
        ...
        SaaS, medical tools for oncology interpretation and rare disease genome
        analysis. In particular, I managed Mercury&apos;s transition to React,
        helped redesign its Symfony API, and successfully migrated OncoKDM from
        Angular to React. These experiences have enabled me to develop solid
        skills in full-stack development.
      </p>

      <p>
        Prior to joining Integragen, I worked as a freelancer on a variety of
        projects including mobile applications, storefronts and custom
        solutions.
      </p>

      <p>
        Currently looking for a challenging professional opportunity, I&apos;m
        passionate about web development and particularly enjoy the opportunity
        to interact at all stages of a project. My expertise in React and
        TypeScript enables me to appreciate type-safe environments, use React
        meta-framework (Next.js, Remix, ...), take advantage of new features
        (React Server Components), and libraries (tanstack/query,
        tanstack/router, tRPC, zod, ...). I&apos;m also proficient in
        transitioning to more modern technology stacks, with a focus on tailored
        solutions rather than simply following trends.
      </p>
      <p>
        Attracted by technical challenges and large-scale projects, I&apos;m
        convinced that it&apos;s in these environments that I can fully express
        my potential and bring real added value. I&apos;m looking for a dynamic
        and innovative company, offering a flexible and collaborative working
        environment, where I can continue to develop and contribute to
        innovative projects.
      </p>
      <h2># Experiences</h2>
      <Experience
